...
//    }
    ...
    private void initRecorder() {
        try {
            ...
            mVideoUrl = new StringBuilder().append(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM)).append(new StringBuilder("/KoghterRecord-").append(new SimpleDateFormat("dd-MM-yyy-hh_mm_ss")
